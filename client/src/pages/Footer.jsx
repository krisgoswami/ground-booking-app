	...
	return (
		<div>
			<div className='flex flex-col lg:flex-row bg-gray-900 lg:h-60'>
				<div className='lg:w-1/2 ml-5 lg:ml-12 mt-5 lg:mt-0'>
					<p className='text-white text-2xl font-bold mb-3'>Book-A-Ground.com</p>
					<p className='text-white mb-5 w-96 lg:w-full text-justify'>Book-A-Ground.com is an app where you can book grounds to play football and cricket with your friends and loved ones. Book a ground near you today! </p>
				</div>
				<div className='lg:w-1/4 mx-5 lg:ml-32 mt-5 lg:mt-0'>
				...
				<div className='lg:w-1/4 mx-5 lg:mr-36 mt-5 lg:mt-0'>
